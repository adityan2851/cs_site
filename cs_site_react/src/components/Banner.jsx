        ...
        <Row md className="p-0">
          ...
          <Tab.Content className="p-0 m-0">
            <Tab.Pane eventKey="first">
              <div id="visionAndMission" className="tabcontent">
                <h2>Vision</h2>
                <p>
                  The Department of Computer Science and Engineering believes in
                  providing quality education to students who will excel in
                  design and development of hardware and software integrated
                  devices through continuous learning and research activities,
                  ethically meeting the social needs.
                </p>

                <h2>Mission</h2>
                <p>
                  <strong>Excellence: </strong> Achieve academic excellence
                  through innovative teaching and continuous improvement thereby
                  promoting research and development in the field of Computer
                  Science and Engineering.
                </p>
                <p>
                  <strong>Adaptability: </strong> Inculcate team work, ethical
                  practices and build necessary skill set in students through
                  career development training programmes to help them adapt to
                  the ever changing market demands.
                </p>
                <p>
                  <strong>Service: </strong> Enrich students with moral values,
                  discipline and high integrity to serve the society and work
            ...
            <Tab.Pane eventKey="second">
              <div id="PEOPSO" className="tabcontent">
                ...
                <p>
                  <strong>Technophile: </strong> Graduates will have the ability
                  and attitude to adapt emerging technological changes in the
                  field of Computer Science and Engineering.
                </p>
                <p>
                  <strong>Team Player: </strong> Possess an ability to
                  collaborate as a team member and team leader to affect
                  technical solutions for computing systems, providing improved
                ...
                <p>
                  ...
                  methodologies and foundational concepts of Computer Science
                  and Engineering to solve computational tasks, model the real
                  world problem using appropriate data structure and algorithm
                  with suitable programming languages.
                </p>
                <p>
                  <strong>Potentiality to design: </strong>Analyze, design and
                  evaluate a computer based system by applying software
                  engineering principles and practices for developing quality
                  software for scientific and business applications.
                </p>
                <p>
                  <strong>Technical Expertise: </strong> Adapt to modern
                  engineering technologies and thereby build robust, reliable,
                  maintainable, scalable, innovative and efficient computing
                  systems by considering social, environmental, economic, and
            ...
            <Tab.Pane eventKey="third">
              <div id="programOutcome" className="tabcontent">
                ...
                <p>
                  <strong>Design/development of solutions: </strong>Use
                ...
                <p>
                  <strong>Environment and sustainability:</strong>Understand the
                ...
                <p>
                  ...
                  and with society at large, such as, being able to comprehend
